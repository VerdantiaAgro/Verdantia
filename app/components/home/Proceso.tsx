            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="mb-20 space-y-4">
                    <div className="inline-block border-l-2 border-[#DBB75F] pl-4">
                        <span className="text-[#DBB75F] text-sm font-bold uppercase tracking-[0.4em]">Metodología</span>
                    </div>
                    <h2 className="text-6xl md:text-8xl font-bold text-white leading-[0.95] tracking-tighter">
                        Del campo <br />
                        <span className="text-[#DBB75F]">al mundo</span>
                    </h2>
                    <p className="text-lg text-[#A1A1AA] max-w-2xl font-light leading-relaxed pt-4">
                        Un proceso meticuloso que garantiza la más alta calidad y frescura,
                        con trazabilidad completa en cada etapa de la cadena de suministro.
                    </p>
                </div>
