...
const Compromiso = () => {
    const compromisos: CompromisoItem[] = [
        {
            titulo: "Trazabilidad",
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="mb-20 space-y-4">
                    <div className="inline-block border-l-2 border-[#DBB75F] pl-4">
                        <span className="text-[#DBB75F] text-sm font-bold uppercase tracking-[0.4em]">Valores</span>
                    </div>
                    <h2 className="text-6xl md:text-8xl font-bold text-white leading-[0.95] tracking-tighter">
                        Nuestro <br />
                        <span className="text-[#DBB75F]">Compromiso</span>
                    </h2>
                ...
                <div className="mt-20 glass-dark border border-white/5 rounded-3xl p-10 lg:p-16">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
                        <div>
                            <div className="text-5xl font-bold text-[#DBB75F] mb-3 tracking-tighter">100%</div>
                            <div className="text-[10px] text-[#A1A1AA] uppercase tracking-[0.2em]">Trazabilidad</div>
                        </div>
                        <div>
                            <div className="text-5xl font-bold text-[#DBB75F] mb-3 tracking-tighter">40%</div>
                            <div className="text-[10px] text-[#A1A1AA] uppercase tracking-[0.2em]">Menos agua</div>
                        </div>
                        <div>
                            <div className="text-5xl font-bold text-[#DBB75F] mb-3 tracking-tighter">25+</div>
                            <div className="text-[10px] text-[#A1A1AA] uppercase tracking-[0.2em]">Certificaciones</div>
                        </div>
                        <div>
                            <div className="text-5xl font-bold text-[#DBB75F] mb-3 tracking-tighter">500+</div>
                            <div className="text-[10px] text-[#A1A1AA] uppercase tracking-[0.2em]">Familias beneficiadas</div>
                        </div>
                    </div>
                </div>
            </div>
